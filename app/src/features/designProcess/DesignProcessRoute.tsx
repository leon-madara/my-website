...
export function DesignProcessRoute() {
  ...
  return (
    <div className="page-content page-content--design-process">
      ...
      <section
        aria-labelledby="dp-orchestration-title"
        className="dp-section dp-section--orchestration"
        id="agent-orchestration"
      >
        <div className="dp-container dp-orchestration-shell dp-flow-block">
          <p className="dp-ai-kicker">Execution Architecture Layer</p>
          <h2 className="dp-ai-headline" id="dp-orchestration-title">
            Once strategy is clear, I convert one complex brief into a
            dependency-driven agent pipeline.
          </h2>
          <div className="dp-ai-copy">
            <p className="dp-ai-body">
              I do not run one giant prompt and hope it lands. I split the work
              into explicit chunks with input and output contracts, then route
              each chunk to the right specialist.
            </p>
            <p className="dp-ai-body">
              Independent tracks run in parallel for speed. Dependent tracks
              wait for upstream outputs. Before promotion, a verifier agent
              audits the result against the original brief so quality is proven,
              not assumed.
            </p>
          </div>

          <div className="dp-orchestration-grid" role="list" aria-label="Agent orchestration roles">
            ...
            <article className="dp-orch-card dp-reveal" role="listitem">
              ...
              <p className="dp-orch-copy">
                Execute bounded chunks only, with zero scope drift and no silent
                branch decisions.
              </p>
            </article>
      ...
      <section
        aria-labelledby="dp-gates-title"
        className="dp-section dp-section--gates"
        id="branch-gates"
      >
        <div className="dp-container dp-gates-shell dp-flow-block">
          <p className="dp-ai-kicker">Release Safety Layer</p>
          <h2 className="dp-ai-headline" id="dp-gates-title">
          ...
          <div className="dp-ai-copy">
            ...
            <p className="dp-ai-body">
              ...
              merges, and preserves reviewable history across complex multi-agent
              sessions.
            </p>
          </div>
          ...
          <div className="dp-command-strip" aria-label="Cross-platform branch gate commands">
            <code className="dp-command dp-reveal">branch-orchestrator.cmd --mode entry --json</code>
            <code className="dp-command dp-reveal">branch-orchestrator.cmd --mode exit --json</code>
            <code className="dp-command dp-reveal">branch-orchestrator.sh --mode entry --json</code>
            <code className="dp-command dp-reveal">branch-orchestrator.sh --mode exit --json</code>
          </div>
        </div>
      </section>
    </div>
