...
const ContactPage = {
    ...
    initContactForm() {
        ...
        // Make form-groups clickable to focus inputs
        const formGroups = form.querySelectorAll('.form-group');
        formGroups.forEach(formGroup => {
            const input = formGroup.querySelector('input, textarea, select');
            if (input) {
                formGroup.addEventListener('click', (e) => {
                    // Only focus if click is not directly on the input/select/textarea
    ...
    setError(input, errorSpan, message) {
        ...
        // Add error class to form-group for container-level styling
        if (formGroup) {
            formGroup.classList.add('has-error');
            formGroup.classList.remove('has-success');
        }
        
        // Keep error class on input for CSS compatibility
    ...
    async handleFormSubmit(e) {
        ...
        try {
            ...
            // Remove validation classes from inputs and form-groups
