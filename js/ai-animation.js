...
class AIAnimationController {
    ...
    showAI(animate = true) {
        ...
        // Update classes for CSS pseudo-element control (dark mode)
        this.aiLogo.classList.remove('visible');
        this.aiLogo.classList.add('resting');
    }
    ...
    showLogo(animate = true) {
        ...
        // Update classes for CSS pseudo-element control (dark mode)
        this.aiLogo.classList.remove('resting');
        this.aiLogo.classList.add('visible');
    }
