...
- Screenshots: ran `node validation/contact-rebuild-screenshots.mjs` against `http://127.0.0.1:5173/contact-rebuild` (outputs ignored under `output/playwright/contact-rebuild/`).
