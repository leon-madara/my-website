...
- Added `design-process.html` page scaffold (Hero -> CTA).
...
- Added the landscape theme toggler and a "MY DESIGN" hero overlay using Organical font.
- Added responsive hero asset swap (mobile SVG on small screens + dark-mode SVG when enabled).
